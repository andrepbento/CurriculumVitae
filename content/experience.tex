...
\CVItem{Sep 2019 - Present, \textit{Researcher}, CISUC - Centre for Informatics and Systems (University of Coimbra)}{
	Researching methods and techniques to improve availability and reliability of microservices using anomaly detection and root-cause analysis.\\
...
\CVItem{Sep 2018 - Jul 2019, \textit{Research Intern}, CISUC - Centre for Informatics and Systems (University of Coimbra)}{
	Researched on Microservices, Observability and Performance Monitoring using Metrics, Logs and Distributed Tracing.
}
